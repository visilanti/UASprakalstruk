            ...
            if(txtidP.getText().equals("")){
                ...
                if(rs.next()){
                    PreparedStatement pStatement =
                        conn.prepareStatement("INSERT INTO tbresep (id,dokter,tanggal,resep)" + "VALUES (?,?,?,?)");
                    
                    pStatement.setString(1, txtidP.getText());
                    pStatement.setString(2, txtdokter.getText());
                    pStatement.setString(3, txttanggal.getText());
